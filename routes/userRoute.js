...
router.post('/register', ensureNotAuthenticated, userValidationRules(), async (req, res, next) => {
...
router.post('/forgotPassword/:token', changePasswordRules(), ensureNotAuthenticated, async (req, res, next) => {
...
router.post('/sendResetLink', ensureNotAuthenticated, async (req, res, next) => {
...
router.post('/sendActivationLink', ensureNotAuthenticated, async (req, res, next) => {
